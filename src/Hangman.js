...
class Hangman extends Component {
  ...
  */
  ...
  gameState(){
    if(this.guessedWord().join("") === this.state.answer) return "You win!";
    if(this.state.nWrong >= this.props.maxWrong) return "You loose!";
    ...
    return (
      <div className='Hangman'>
        ...
        <img 
           ...
           src={(this.state.nWrong <= 6 ? this.props.images[this.state.nWrong] : this.props.images[6])}/>
        ...
        <h2>Number of wrong words so far : {this.state.nWrong}</h2>
